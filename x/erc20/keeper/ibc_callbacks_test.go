...
import (
	...
	"github.com/nnlgsakib/aigent/x/erc20/keeper"
	...
	"github.com/nnlgsakib/aigent/contracts"
...
func (suite *KeeperTestSuite) TestOnRecvPacket() {
	...
	testCases := []struct {
		...
		},
		{
			...
			malleate: func() {
				transfer := transfertypes.NewFungibleTokenPacketData(registeredDenom, "100", "aigen", ethsecpAddrCosmos, "")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
...
func (suite *KeeperTestSuite) TestConvertCoinToERC20FromPacket() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			malleate: func() transfertypes.FungibleTokenPacketData {
				return transfertypes.NewFungibleTokenPacketData("uaigent", "10", "", "", "")
			},
			expPass: false,
		},
		{
			...
			malleate: func() transfertypes.FungibleTokenPacketData {
				return transfertypes.NewFungibleTokenPacketData("uaigent", "10", senderAddr, "", "")
			},
			expPass: true,
		},
		{
